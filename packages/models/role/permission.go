...
var InsufficientPermission *ExternalError.Error = ExternalError.New("Недостаточно прав для выполнения данной операции", http.StatusForbidden)

func VerifyPermissions(required *permissions, permitted *permissions, targetRole *Role) *ExternalError.Error {
